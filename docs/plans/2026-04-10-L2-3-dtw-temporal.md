...
Methodology rationale (DTW + NCC + Sakoe-Chiba band) and the empirical NCC thresholds are sourced from `research/synthesis/deep-read-dtw-ncc-methodology-2026-04-14.md` (sibling literature-synthesis repo). The NCC numpy reference implementation and edge-case handling are sourced verbatim from `docs/research/ncc-implementation-2026-04-14.md` (this repo). Both are cited in line in the relevant task bodies below.
