...
**Gilon, S., Miller, E.Y. & Uhlrich, S.D. (2026).** OpenCap Monocular: 3D Human Kinematics and Musculoskeletal Dynamics from a Single Smartphone Video. University of Utah preprint.
[OpenCap Monocular — refines WHAM pose with optimization + physics-based/ML kinetics; 4.8° rotational MAE, 3.4 cm pelvis translation MAE; 48%/69% better than CV-only baseline. Single-video premium-tier candidate.]
...
**Harris-Hayes, M. et al. (2016).** Movement Pattern Training To Improve Function in People with Chronic Hip Joint Pain: A Feasibility Randomized Clinical Trial. *JOSPT*, 46(6):452–461. PMC manuscript nihms793174.
https://doi.org/10.2519/jospt.2016.6279

**Harris-Hayes, M. et al. (2018).** Reduced Hip Adduction is Associated with Improved Function after Movement Pattern Training in Young People with Chronic Hip Joint Pain. *JOSPT*, 48(4):316–324. PMC manuscript nihms971315.
https://doi.org/10.2519/jospt.2018.7810
...
**Joyce, C.T., Beneciuk, J.M. & George, S.Z. (2023).** Concerns on the Science and Practice of a Movement System. *Physical Therapy*, 103:pzad087.
https://doi.org/10.1093/ptj/pzad087
[Skeptical counterpoint to Sahrmann's Movement System framing — argues diagnostic categories lack predictive validity. Important for balanced framing of movement-system reasoning in the tool.]
...
**Liu, J., Liu, M., Liu, H. & Li, W. (2025).** TCPFormer: Learning Temporal Correlation with Implicit Pose Proxy for 3D Human Pose Estimation. arXiv 2501.01770.
https://arxiv.org/abs/2501.01770
[State-of-the-art multi-frame 3D lift — outperforms MotionBERT on Human3.6M and MPI-INF-3DHP. Candidate for server-side 3D lifting when code releases.]
...
**Miller, E.Y., Tan, T., Falisse, A. & Uhlrich, S.D. (2025).** Integrating Machine Learning with Musculoskeletal Simulation Improves OpenCap Video-Based Dynamics Estimation. *bioRxiv*.
https://doi.org/10.64898/2025.12.19.695562
[Hybrid ML + physics approach improves ground reaction force, joint moment, and joint contact force estimates from smartphone video kinematics. Direct premium-tier pipeline reference.]
...
**OpenCap Best Practices (web).** OpenCap.
https://www.opencap.ai/best-practices
...
https://www.physio-pedia.com/Classification_Of_Low_Back_Pain_Using_Shirley_Sahrmann's_Movement_System_Impairments,_An_Overview_Of_The_Concept
[Practitioner-oriented summary of Sahrmann MSI framework applied to LBP classification. Reference for mapping movement-impairment categories to chain-logic rules.]
...
**PubMed 41639883 (Sabo et al. 2026).** Development and evaluation of a vision pose-tracking based Beighton score tool for generalized joint hypermobility: 91.9% sensitivity, 42.4% specificity, n=125.
https://pubmed.ncbi.nlm.nih.gov/41639883/

**Rajagopal, A., Dembia, C.L., DeMers, M.S., Delp, D.D., Hicks, J.L. & Delp, S.L. (2016).** Full Body Musculoskeletal Model for Muscle-Driven Simulation of Human Gait. *IEEE Transactions on Biomedical Engineering*, 63(10):2068–2079. PMC manuscript nihms818926.
https://doi.org/10.1109/TBME.2016.2586891
[Open-source full-body MSK model for gait simulation — foundation reference for OpenCap/OpenSim-based dynamics pipelines in the premium tier.]
...
**Sahrmann, S. (2017).** The How and Why of the Movement System as the Identity of Physical Therapy. *International Journal of Sports Physical Therapy*, 12(6):862–869.
[Foundational statement of the Movement System / kinesiopathologic framework. Grounds the clinical reasoning the tool operationalizes.]

**Sahrmann, S. (2021).** Defining Our Diagnostic Labels Will Help Define Our Movement Expertise and Guide Our Next 100 Years. *Physical Therapy*, 101:pzaa196.
https://doi.org/10.1093/ptj/pzaa196
[Argument for movement-diagnosis labels as the PT profession's identity; paired with Joyce et al. (2023) for balanced view.]
...
**Shin, S., Kim, J., Halilaj, E. & Black, M.J. (2024).** WHAM: Reconstructing World-Grounded Humans with Accurate 3D Motion. *CVPR 2024*.
https://wham.is.tue.mpg.de/
[State-of-the-art world-grounded 3D human motion recovery from monocular video — foundation for OpenCap Monocular; handles moving cameras without foot sliding.]
...
**Uhlrich, S.D., Jackson, R.W., Seth, A., Kolesar, J.A. & Delp, S.L. (2022).** Muscle coordination retraining inspired by musculoskeletal simulations reduces knee contact force. *Scientific Reports*.
[MSK simulation-driven gait retraining (gastrocnemius-avoidance) cut knee contact force 12% via EMG biofeedback. Mechanistic template for chain-logic interventions.]

**Uhlrich, S.D., Falisse, A., Kidziński, Ł. et al. (2023).** OpenCap: Human movement dynamics from smartphone videos. *PLOS Computational Biology*, 19(10):e1011462.
https://doi.org/10.1371/journal.pcbi.1011462
[Open-source platform combining pose estimation + biomechanical models + physics-based simulation for kinematics and dynamics from two smartphones. Reference architecture for premium server-side pipeline.]

**Uplift Labs.**
https://www.uplift.ai/

**Van Dillen, L.R., Norton, B.J., Sahrmann, S.A. et al. (2016).** Efficacy of classification-specific treatment and adherence on outcomes in people with chronic low back pain: A one-year follow-up, prospective, randomized, controlled clinical trial. *Manual Therapy*, 24:52–64.
https://doi.org/10.1016/j.math.2016.04.003
[RCT evidence that Sahrmann-style MSI classification-specific treatment improves chronic LBP outcomes. Clinical evidence base for movement-system rule selection.]
...
**Xu, Y., Zhang, J., Zhang, Q. & Tao, D. (2022).** ViTPose: Simple Vision Transformer Baselines for Human Pose Estimation. *NeurIPS 2022*.
https://github.com/ViTAE-Transformer/ViTPose
[Plain ViT backbone for 2D keypoint estimation — 80.9 AP on MS COCO. Scalable 100M–1B. Candidate backbone for mid-tier on-device or server 2D keypoint extraction.]
